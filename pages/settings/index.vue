...
function validate(state: any): FormError[] {
  const errors = []
  if (!state.value.name) errors.push({ path: 'name', message: 'Please enter your name.' })
  if (!state.value.email) errors.push({ path: 'email', message: 'Please enter your email.' })
  if ((state.value.password_current && !state.value.password_new) || (!state.value.password_current && state.value.password_new)) errors.push({ path: 'password', message: 'Please enter a valid password.' })
  return errors
}
